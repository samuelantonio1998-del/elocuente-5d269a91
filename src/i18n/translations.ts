...
export const translations: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    "about.p1": "Elocuente is a residential development designed for those who want to live well. Two blocks of contemporary architecture, quality finishes and generous spaces — in a privileged location between Leiria and the Atlantic Coast.",
    "about.p2": "A project for those who value tranquillity, comfort and life at a different pace.",
