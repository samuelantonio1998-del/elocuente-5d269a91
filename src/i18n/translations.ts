...
export const translations: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    "about.p1": "O Elocuente é um condomínio pensado para quem quer viver bem. Dois blocos de arquitetura contemporânea, acabamentos de qualidade e espaços generosos — numa localização privilegiada entre Leiria e a Costa Atlântica.",
    "about.p2": "Um projeto para quem valoriza tranquilidade, conforto e uma vida a um ritmo diferente.",
  ...
  en: {
    ...
    "about.p1": "Elocuente is a residential development designed for those who want to live well. Two contemporary buildings with quality finishes and generous spaces — in a privileged location between Leiria and the Atlantic Coast.",
    "about.p2": "A project for those who value peace, comfort and a different pace of life.",
    ...
    "amenities.desc": "Designed with daily comfort in mind. Modern finishes, private parking and architecture built to make the most of natural light — because a great home is felt in every moment.",
