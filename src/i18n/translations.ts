...
export const translations: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    "hero.subtitle": "Um condomínio contemporâneo numa localização central — a minutos do centro de Leiria e da costa atlântica, com a tranquilidade de viver fora da cidade.",
  ...
  en: {
    ...
    "hero.subtitle": "A contemporary condominium in a central location — minutes from central Leiria and the Atlantic coast, with the calm of living outside the city.",
  ...
  es: {
    ...
    "hero.subtitle": "Un condominio contemporáneo en una ubicación central — a minutos del centro de Leiria y de la costa atlántica, con la tranquilidad de vivir fuera de la ciudad.",
