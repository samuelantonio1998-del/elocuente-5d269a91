...
const units: Unit[] = [
  ...
  { id: "B01", building: "B", floor: 0, type: "T2", area: "104 m²", parking: 2, orientation: "Sul / Nascente", status: "unknown" },
  { id: "B02", building: "B", floor: 0, type: "T2", area: "105 m²", parking: 2, orientation: "Norte / Poente", status: "unknown" },
  { id: "B03", building: "B", floor: 0, type: "T2", area: "87 m²", parking: 2, orientation: "Sul / Nascente", status: "unknown" },
  { id: "B04", building: "B", floor: 0, type: "T2", area: "92 m²", parking: 2, orientation: "Norte / Poente", status: "unknown" },
